...
import cc.tianbin.mybatis.reflection.MetaClass;
...
public class BeanWrapper extends BaseWrapper {
    ...
    public MetaObject instantiatePropertyValue(String name, PropertyTokenizer prop, ObjectFactory objectFactory) {
        ...
        try {
            ...
            throw new ReflectionException(e, "Cannot set value of property '{}' because '{}' is null and cannot be instantiated on instance of {}. Cause: ",
